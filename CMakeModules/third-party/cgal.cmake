...
if(WIN32)
  ...
  if ("$ENV{CONDA_PREFIX}" STREQUAL "")
    ...
    set(TGT_FILE "$ENV{CONDA_PREFIX}/Library/bin/libgmp-10.dll")
    if (NOT EXISTS ${TGT_FILE})
      file(COPY_FILE "${cgal_SOURCE_DIR}/auxiliary/gmp/lib/libgmp-10.dll" "${TGT_FILE}")
    endif()

    set(TGT_FILE "$ENV{CONDA_PREFIX}/Library/bin/libmpfr-4.dll")
    if (NOT EXISTS ${TGT_FILE})
      file(COPY_FILE "${cgal_SOURCE_DIR}/auxiliary/gmp/lib/libmpfr-4.dll" "${TGT_FILE}")
    endif()
  endif()
endif()
