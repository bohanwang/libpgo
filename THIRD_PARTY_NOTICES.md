...
| Ceres Solver | 2.2.0, SHA-256 `48b2302a7986ece172898477c3bcd6deb8fb5cf19b3327bc49969aad4cede82d` | BSD-3-Clause | Python/full |
...
| oneTBB | 2021.12.0, SHA-256 `2c2a3b7eaa31e7e6ac5b810965bce6253e953c95b37e3c3a598cc22488e6badb` | Apache-2.0 | Core fallback; release wheels use external Conda TBB |
...
files in the source tree. System libraries and Conda-provided runtime
dependencies—including GMP, MPFR, Imath, TBB, MKL, BLAS, and LAPACK—are not
copied into the 0.0.4 wheels. Their licenses remain associated with the
documented runtime environment.
