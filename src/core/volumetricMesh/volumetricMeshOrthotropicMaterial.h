...
inline double VolumetricMesh::OrthotropicMaterial::getE1() const
{
  return E1_;
}
inline double VolumetricMesh::OrthotropicMaterial::getE2() const
{
  return E2_;
}
inline double VolumetricMesh::OrthotropicMaterial::getE3() const
{
  return E3_;
}
inline double VolumetricMesh::OrthotropicMaterial::getNu12() const
{
  return nu12_;
}
inline double VolumetricMesh::OrthotropicMaterial::getNu23() const
{
  return nu23_;
}
inline double VolumetricMesh::OrthotropicMaterial::getNu31() const
{
  return nu31_;
}
inline double VolumetricMesh::OrthotropicMaterial::getG12() const
{
  return G12_;
}
inline double VolumetricMesh::OrthotropicMaterial::getG23() const
{
  return G23_;
}
inline double VolumetricMesh::OrthotropicMaterial::getG31() const
{
  return G31_;
}

inline void VolumetricMesh::OrthotropicMaterial::setE1(double E1)
{
  E1_ = E1;
}
inline void VolumetricMesh::OrthotropicMaterial::setE2(double E2)
{
  E2_ = E2;
}
inline void VolumetricMesh::OrthotropicMaterial::setE3(double E3)
{
  E3_ = E3;
}
inline void VolumetricMesh::OrthotropicMaterial::setNu12(double nu12)
{
  nu12_ = nu12;
}
inline void VolumetricMesh::OrthotropicMaterial::setNu23(double nu23)
{
  nu23_ = nu23;
}
inline void VolumetricMesh::OrthotropicMaterial::setNu31(double nu31)
{
  nu31_ = nu31;
}
inline void VolumetricMesh::OrthotropicMaterial::setG12(double G12)
{
  G12_ = G12;
}
inline void VolumetricMesh::OrthotropicMaterial::setG23(double G23)
{
  G23_ = G23;
}
inline void VolumetricMesh::OrthotropicMaterial::setG31(double G31)
{
  G31_ = G31;
}
