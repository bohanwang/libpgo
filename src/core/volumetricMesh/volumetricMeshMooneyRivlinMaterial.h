...
inline VolumetricMesh::MooneyRivlinMaterial::MooneyRivlinMaterial(std::string name, double density, double mu01, double mu10, double v1):
  VolumetricMesh::Material(name, density), mu01_(mu01), mu10_(mu10), v1_(v1)
{
}
inline VolumetricMesh::MooneyRivlinMaterial::MooneyRivlinMaterial(const MooneyRivlinMaterial &mooneyRivlinMaterial):
  VolumetricMesh::Material(mooneyRivlinMaterial.getName(), mooneyRivlinMaterial.getDensity()), mu01_(mooneyRivlinMaterial.getmu01()), mu10_(mooneyRivlinMaterial.getmu10()), v1_(mooneyRivlinMaterial.getv1())
{
}
inline double VolumetricMesh::MooneyRivlinMaterial::getmu01() const
{
  return mu01_;
}
inline double VolumetricMesh::MooneyRivlinMaterial::getmu10() const
{
  return mu10_;
}
inline double VolumetricMesh::MooneyRivlinMaterial::getv1() const
{
  return v1_;
}
inline void VolumetricMesh::MooneyRivlinMaterial::setmu01(double mu01)
{
  mu01_ = mu01;
}
inline void VolumetricMesh::MooneyRivlinMaterial::setmu10(double mu10)
{
  mu10_ = mu10;
}
inline void VolumetricMesh::MooneyRivlinMaterial::setv1(double v1)
{
  v1_ = v1;
}
