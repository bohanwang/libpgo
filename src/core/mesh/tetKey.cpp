...
const int pgo::Mesh::OTetKey::tetFaceIndex[4][3] =  { { 1, 2, 3 }, { 0, 3, 2 }, { 0, 1, 3 }, { 0, 2, 1 } };

const int pgo::Mesh::OTetKey::tetEdgeIndex[6][2] = {
 { 0, 1 }, { 1, 2 }, { 2, 0 },
 { 0, 3 }, { 1, 3 }, { 2, 3 } };


void pgo::Mesh::OTetKey::permute(int v0, int v1, int v2, int v3, int &r0, int &r1, int &r2, int &r3)
{
  int minInd = 0;
  r0 = v0;
  if (v1 < r0)
