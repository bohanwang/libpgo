...
CenterOfMassEnergy::CenterOfMassEnergy(const pgo::Mesh::TetMeshGeo &tetMesh, const ES::V3d &tgtCoM, const ES::M3d &projMat)
{
  ES::MXd vtxInit;
  ES::MXi tetInit;
...
void CenterOfMassEnergy::func_gradient(ES::ConstRefVecXd x, ES::RefVecXd grad, double &energy, ES::V3d &com)
{
  // eng = (N / D - tgtCoM)^2
