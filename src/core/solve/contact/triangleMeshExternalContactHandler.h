...
public:
    TriangleMeshExternalContactHandler(const std::vector<EigenSupport::V3d>& vertices,
                                       const std::vector<EigenSupport::V3i>& triangles, int nDOFs,
                                       const std::vector<Mesh::TriMeshRef>& externalSurfaces, int subdivideTriangle = 1,
                                       const std::vector<int>*    vertexEmbeddingIndices = nullptr,
