#!/usr/bin/env python3
"""Run IPC simulation and animation-conversion batches from a JSON config."""
...
IPC_ROOT = REPO_ROOT / "examples" / "ipc"
DEFAULT_CONFIG = IPC_ROOT / "ipc_batch.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run IPC simulation and convertAnimation batches from JSON jobs.")
