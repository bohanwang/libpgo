...
This page is the cubic-specific deep dive. For the cross-layout overview (`cubic` + `tet` + `shell`), shared quick start, and tet/shell entry commands, see [`examples/legacy/README.md`](../README.md).
...
cmake --build --preset base_no_mkl_release --target cubicMesher runSim convertAnimation
```
